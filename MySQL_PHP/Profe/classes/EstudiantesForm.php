...
class EstudiantesForm
{
    ...
    public function getEstudiantes()
    {
        ...
        $estudiantes = [];
        $respuesta = $conn->query("SELECT * FROM estudiantes");
    ...
    public function procesarFormulario()
    {
        ...
        if (isset($_POST['txtNombre']) && isset($_POST['txtApellido']) && isset($_POST['intDNI']) && isset($_POST['txtCarrera'])) {
            ...
            if ($this->blAlertError == false) {
                try {
                    $queryString = "INSERT INTO estudiantes (nombre, apellido, DNI, carrera) 
    ...
    protected function validar($nombre, $apellido, $dni, $carrera)
    {
        return [];
    }
